({
    configureTheme : function(cmp) {
        ...
        var colTitleAlign = cmp.get("v.columnTitleAlignment");
        cmp.set("v.intColumnTitleAlignment", 'text-align: ' + colTitleAlign + ';');

        var colTitleSize = cmp.get("v.columnTitleFontSize");
        cmp.set("v.intColumnTitleFontSize", 'font-size: ' + colTitleSize + 'px;');

        var newColor = cmp.get("v.backgroundColor");
        
        var parent = cmp.find("parent");
        var feedbackButton = cmp.find("feedback-button");
        var shareButton = cmp.find("shareButton");
