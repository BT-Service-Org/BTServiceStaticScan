...
import getFieldsAndRecords from '@salesforce/apex/PSCDatatableCtrl.getFieldsAndRecords';

export default class PscDatatable extends LightningElement {
    ...
    @api getAllArticleVersionData; // This should only be used with knowledge object to get all the version data
    ...
    connectedCallback() {
        ...
        getFieldsAndRecords({
            ...
            getAllArticleVersionData: this.getAllArticleVersionData
        })
            .then(data => {
                //get the entire map
